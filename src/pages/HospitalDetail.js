...
const HospitalDetail = () => {
  ...
  const fetchSimilarHospitals = async () => {
    try {
      ...
      setSimilarHospitals([
        { _id: '1', name: "University Hospital Munich", rating: "9.90", mainImage: null },
        { _id: '2', name: "University Hospital Frankfurt", rating: "9.85", mainImage: null },
        { _id: '3', name: "Beta Clinic Bonn", rating: "9.80", mainImage: null },
        { _id: '4', name: "Helios Hospital Berlin", rating: "9.75", mainImage: null }
      ]);
    }
  };
  ...
  const features = Array.isArray(hospital?.featureAndFacts) && hospital.featureAndFacts.length > 0
    ? hospital.featureAndFacts
    : [
      {
        title: "Proton beams for eye cancer",
        description: "The clinic achieved a milestone by curing its 3,000th eye cancer patient using proton therapy. This treatment involves using protons to target the tumor while minimizing damage to healthy surrounding tissue."
      },
      {
        title: "The heart of scientific research",
        description: "Leading medical research facility with cutting-edge technology and innovative treatments."
      },
      {
        title: "Over 800 clinical trials annually",
        description: "Conducting extensive clinical research to advance medical knowledge and patient care."
      },
      {
        title: "Revolutionary achievements",
        description: "Pioneering medical breakthroughs and innovative treatment methods."
      },
      {
        title: "900 cured stroke patients annually",
        description: "Specialized stroke treatment program with exceptional recovery rates."
      }
    ];
    ...
    <div className="container-fluid px-0">
      ...
      <div className="bg-white">
        <div className="container py-4">
            ...
            <div className="col-lg-8">
              <div className="position-relative">
                <img 
                  ...
                  onError={(e) => {
                    e.target.src = 'https://images.unsplash.com/photo-1582750433449-648ed127bb54?w=800&h=400&fit=crop&crop=center&random=' + Math.random();
                  }}
                />
                {/* Rating badge */}
                {hospital.rating && (
                      ...
                      <div className="position-relative h-100">
                        ...
                        {index === 3 && hospital.gallery.length > 5 && (
                          <div className="position-absolute bottom-0 end-0 m-2">
                            <span className="badge bg-white text-dark shadow-sm" style={{ fontSize: '0.8rem' }}>
          ...
          {/* Navigation Tabs */}
          <div className="nav nav-pills nav-fill rounded-pill p-2" style={{ backgroundColor: '#dcf8ec' }}>
            {['Overview', 'Specialities', 'Features', 'About', 'Doctors', 'Gallery', 'Reviews', 'Location'].map((tab) => (
              <button
                key={tab}
                className={`nav-link hospital-tab ${activeTab === tab ? 'active' : ''}`}
                style={{
                  backgroundColor: activeTab === tab ? '#03cd77' : 'transparent',
      ...
      <div className="container py-4">
        <div className="row">
          ...
          <div className="col-lg-8">
              ...
              <div>
                ...
                <div className="row mb-4">
                  <div className="col-md-3 mb-3">
                    <div className="border-0 shadow-sm" style={{ backgroundColor: '#f6f6f6', height: '80px', padding: '0', borderRadius: '8px' }}>
                      <div className="d-flex justify-content-center align-items-center" style={{ height: '100%', padding: '20px' }}>
                        <i className="far fa-star text-success fa-2x me-3"></i>
                        <h6 className="mb-0 fw-bold">{hospital.userScore ? `${hospital.userScore}% UserScore` : 'N/A UserScore'}</h6>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-3 mb-3">
                    <div className="border-0 shadow-sm" style={{ backgroundColor: '#f6f6f6', height: '80px', padding: '0', borderRadius: '8px' }}>
                      <div className="d-flex justify-content-center align-items-center" style={{ height: '100%', padding: '20px' }}>
                        ...
                        <h6 className="mb-0 fw-bold">{hospital.foundedYear ? `Founded in ${hospital.foundedYear}` : 'Founded year N/A'}</h6>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-3 mb-3">
                    <div className="border-0 shadow-sm" style={{ backgroundColor: '#f6f6f6', height: '80px', padding: '0', borderRadius: '8px' }}>
                      <div className="d-flex justify-content-center align-items-center" style={{ height: '100%', padding: '20px' }}>
                        ...
                        <h6 className="mb-0 fw-bold">{hospital.totalPatients ? `${hospital.totalPatients.toLocaleString()} patients` : '0 patients'}</h6>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-3 mb-3">
                    <div className="border-0 shadow-sm" style={{ backgroundColor: '#f6f6f6', height: '80px', padding: '0', borderRadius: '8px' }}>
                      <div className="d-flex justify-content-center align-items-center" style={{ height: '100%', padding: '20px' }}>
                        ...
                        <h6 className="mb-0 fw-bold">{hospital.totalUnits ? `${hospital.totalUnits} units` : '0 units'}</h6>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <ul className="list-unstyled">
                    <li className="mb-4 d-flex align-items-start">
                      <div className="me-3 d-flex align-items-center justify-content-center" style={{ 
                        ...
                        <i className="fas fa-bed text-dark" style={{ fontSize: '18px' }}></i>
                      </div>
                      <div>
                        <div className="fw-bold text-dark">Size & Capacity</div>
                        <div className="text-muted">
                          OT: {hospital.sizeAndCapacity?.operationTheatres || 0}, 
                          ICU: {hospital.sizeAndCapacity?.icus || 0}, 
                          Patient Beds: {hospital.sizeAndCapacity?.patientBeds || 0}+
                        </div>
                      </div>
                    </li>
                    <li className="mb-4 d-flex align-items-start">
                      <div className="me-3 d-flex align-items-center justify-content-center" style={{ 
                        ...
                        <i className="fas fa-building text-dark" style={{ fontSize: '18px' }}></i>
                      </div>
                      <div>
                        <div className="fw-bold text-dark">Clinic type</div>
                        <div className="text-muted">{hospital.clinicType || 'Not specified'}</div>
                      </div>
                    </li>
                    <li className="mb-4 d-flex align-items-start">
                      <div className="me-3 d-flex align-items-center justify-content-center" style={{ 
                        ...
                        <i className="fas fa-plus-circle text-dark" style={{ fontSize: '18px' }}></i>
                      </div>
                      <div>
                        <div className="fw-bold text-dark">Type of care</div>
                        <div className="text-muted">{hospital.typeOfCare || 'Not specified'}</div>
                      </div>
                    </li>
                    <li className="mb-4 d-flex align-items-start">
                      <div className="me-3 d-flex align-items-center justify-content-center" style={{ 
                        ...
                        <i className="fas fa-users text-dark" style={{ fontSize: '18px' }}></i>
                      </div>
                      <div>
                        <div className="fw-bold text-dark">Age group</div>
                        <div className="text-muted">{hospital.ageGroup || 'Not specified'}</div>
                      </div>
                    </li>
                    {hospital.googleReviewsRating && (
                      <li className="mb-4 d-flex align-items-start">
                        <div className="me-3 d-flex align-items-center justify-content-center" style={{ 
                          ...
                          <i className="fab fa-google text-dark" style={{ fontSize: '18px' }}></i>
                        </div>
                        <div>
                          <div className="fw-bold text-dark">{hospital.googleReviewsRating}/5 on Google</div>
                          <small className="text-muted">Google Reviews Rating</small>
                        </div>
                      </li>
                    )}
                  </ul>
                ...
                <div className="mb-5">
                  <h3 className="h4 fw-bold text-black mb-3">
                    Certificates <i className="fas fa-info-circle text-muted"></i>
                  </h3>
                  <div className="d-flex overflow-auto">
                    {[
                      { name: 'Clean Hands Count', image: '/certificates/Clean-Hands-Count-Hand.jpg' },
                      ...
                      { name: 'ENETS', image: '/certificates/EANM_Master-Logo.jpg' },
                      { name: 'Leading Medicine Guide', image: '/certificates/leading-medicine-guide.png' }
                    ].map((cert, index) => (
                ...
                <div className="mb-4">
                  <h3 className="h4 fw-bold text-dark mb-3">Features & Facts</h3>
                      ...
                      <div key={index} className="mb-2" style={{ backgroundColor: 'white', borderRadius: '8px', border: '1px solid #e9ecef', overflow: 'hidden' }}>
                        <div 
                          ...
                          style={{ 
                            ...
                            color: expandedFeatures[index] ? '#20c997' : '#212529',
                            padding: '16px 20px',
                            fontSize: '0.95rem',
                            fontWeight: '500',
                            cursor: 'pointer',
                            borderBottom: expandedFeatures[index] ? '1px solid #e9ecef' : 'none'
                          }}
                          onClick={() => toggleFeature(index)}
                        >
                          <i className="fas fa-lightbulb me-3" style={{ color: expandedFeatures[index] ? '#20c997' : '#6c757d' }}></i>
                          {feature.title}
                          <div className="ms-auto">
                            <i 
                              className={`fas ${expandedFeatures[index] ? 'fa-minus' : 'fa-plus'}`} 
                              style={{ 
                                color: '#6c757d'
                              }}
                            ></i>
                    ...
                    {hospital.departments && hospital.departments.length > 0 ? (
                      ...
                      <div key={index} className="mb-2" style={{ backgroundColor: 'white', borderRadius: '8px', border: '1px solid #e9ecef', overflow: 'hidden' }}>
                        <div 
                          ...
                          onClick={() => toggleFeature(index)}
                        >
                          <i className="fas fa-sitemap me-3" style={{ color: expandedFeatures[index] ? '#20c997' : '#6c757d' }}></i>
                          {dept.name}
                          <div className="ms-auto">
                            <i 
                              className={`fas ${expandedFeatures[index] ? 'fa-minus' : 'fa-plus'}`} 
                        ...
                        {expandedFeatures[index] && dept.doctors && dept.doctors.length > 0 && (
                          <div style={{ padding: '0 20px 20px 20px', color: '#495057', fontSize: '0.9rem', lineHeight: '1.5' }}>
                        ...
                        <div key={index} className="col-md-4">
                          <div className="position-relative">
                            <img 
                              ...
                              onError={(e) => {
                                e.target.src = `https://via.placeholder.com/300x200/007bff/ffffff?text=Gallery+${index + 1}`;
                              }}
                            />
                ...
                <div className="mt-5">
                  ...
                  {[
                    ...
                    <div key={index} className="border-0 bg-light mb-2 shadow-sm" style={{ borderRadius: '8px' }}>
                      <div className={`card-body ${review.review ? 'p-3' : 'py-1 px-3'}`} style={{ minHeight: review.review ? 'auto' : '60px' }}>
                          ...
                          <div className="flex-grow-1">
                            <div className="d-flex justify-content-between align-items-center">
                              ...
                              <div className="d-flex flex-column align-items-end">
                                ...
                                <div className="d-flex align-items-center">
                                  {review.verified && (
                                    <span className="badge bg-primary me-2" style={{ fontSize: '0.75rem' }}>verified</span>
                                  )}
                            ...
                            {review.review && (
                              <p className="mb-0 text-dark mt-2">{review.review}</p>
                            )}
                          </div>
                        </div>
                      </div>
                      ...
                      {(Array.isArray(hospital?.faq) && hospital.faq.length > 0
                        ...
                        <div key={index} className="mb-2" style={{ backgroundColor: 'white', borderRadius: '8px', border: '1px solid #e9ecef', overflow: 'hidden' }}>
                          <div 
                            ...
                            style={{ 
                              backgroundColor: 'white', 
                              color: expandedFeatures[index + 10] ? '#20c997' : '#212529',
                              padding: '16px 20px',
                              fontSize: '0.95rem',
                              fontWeight: '500',
                              cursor: 'pointer',
                              borderBottom: expandedFeatures[index + 10] ? '1px solid #e9ecef' : 'none'
                            }}
                          ...
                          >
                            ...
                            <div className="ms-auto">
                              <i 
                                className={`fas ${expandedFeatures[index + 10] ? 'fa-minus' : 'fa-plus'}`} 
                                style={{ 
                                  color: '#6c757d'
                                }}
                              ></i>
                          ...
                          {expandedFeatures[index + 10] && (
                            <div style={{ padding: '0 20px 20px 20px', color: '#495057', fontSize: '0.9rem', lineHeight: '1.5', backgroundColor: 'white' }}>
                              {faq.answer}
                            </div>
                          )}
                        </div>
            ...
            {/* Doctors Tab */}
            {activeTab === 'Doctors' && (
              <DoctorsTab hospital={hospital} />
            )}

            {/* Gallery Tab */}
            {activeTab === 'Gallery' && (
              <GalleryTab hospital={hospital} />
            )}
          ...
          <div className="col-lg-4">
            ...
            <div className="card border-0 mb-4 shadow-sm mx-auto" style={{ backgroundColor: 'white', borderRadius: '12px', padding: '20px', maxWidth: '360px' }}>
              <div className="card border-0 shadow-sm" style={{ borderRadius: '12px', overflow: 'hidden' }}>
                ...
                />
                <div className="p-4 text-center" style={{ backgroundColor: '#000c44' }}>
                  <div className="mb-3">
                    <img 
                      src="/logo.png" 
                      alt="Logo"
                  ...
                  <h5 className="card-title text-white mb-2" style={{ fontSize: '1rem', fontWeight: 'bold' }}>For Any Service to Contact us</h5>
                  <p className="card-text text-white mb-3" style={{ fontSize: '0.85rem' }}>If you need any help please feel free to contact us</p>
            ...
            {/* Contact Form */}
            <div className="card border-0 shadow-sm mx-auto" style={{ backgroundColor: 'white', borderRadius: '12px', maxWidth: '360px' }}>
              <div className="card-body p-4">
                <h5 className="card-title text-primary fw-bold mb-4">Get In Touch</h5>
                <form>
                  <div className="mb-3">
                    <input 
                      type="text" 
        ...
        <div className="mt-5">
          ...
          {similarHospitals.length > 0 ? (
            <div className="position-relative">
              <div className="d-flex overflow-auto" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                <div className="d-flex" style={{ gap: '16px' }}>
                  {similarHospitals.map((similarHospital, index) => (
                    <div key={similarHospital._id || index} className="flex-shrink-0" style={{ width: '280px' }}>
                      <div className="card border-0 shadow-sm position-relative" style={{ borderRadius: '12px', overflow: 'hidden' }}>
                        <div className="position-relative">
                          ...
                          <div className="position-absolute top-0 start-0 m-2">
                            <span className="badge d-flex align-items-center" style={{ 
                              ...
                              <i className="fas fa-star me-1" style={{ color: '#fbbf24' }}></i>
                          ...
                          <div className="position-absolute bottom-0 start-0 m-2">
                            <div className="bg-white rounded-circle d-flex align-items-center justify-content-center shadow-sm" style={{ width: '32px', height: '32px' }}>
                              <i className="fas fa-map-marker-alt text-dark" style={{ fontSize: '14px' }}></i>
                            </div>
                          </div>
                          ...
                          {index === 2 && (
                            <div className="position-absolute top-0 end-0 m-2">
                              <div className="bg-white rounded-circle d-flex align-items-center justify-content-center shadow-sm" style={{ width: '32px', height: '32px' }}>
                                <i className="fas fa-clock text-dark" style={{ fontSize: '14px' }}></i>
                              </div>
                            </div>
                          )}
                        </div>
                        ...
                        <div className="card-body p-3">
                          <h6 className="card-title fw-bold text-dark mb-0" style={{ fontSize: '0.9rem', lineHeight: '1.3' }}>
              ...
              <div className="position-absolute top-50 end-0 translate-middle-y" style={{ zIndex: 10 }}>
                <button className="btn btn-dark rounded-circle d-flex align-items-center justify-content-center" style={{ width: '40px', height: '40px' }}>
